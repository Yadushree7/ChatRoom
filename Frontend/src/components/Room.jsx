...
//                     background: "linear-gradient(to right, #000000 0%, #1a0000 20%, #330000 40%, #660000 60%, #990000 80%, #FF0000 100%)",
...
const ScrollableDiv = styled.div`
  ...
  border-radius: 10px;
  padding: 10px;
  background: linear-gradient(270deg, #000000, #330000, #660000, #990000, #FF0000, #660000, #330000, #000000);
...
const MessageBubble = styled.div`
  ...
  background: linear-gradient(270deg, #000000, #950F35, #B51240, #FF0000, #950F35, #000000);
  background-size: 600% 600%;
  ...
  return (
    ...
    >
      ...
      >
              ...
              {users.map((user, index) => (
                <li
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    marginBottom: "8px",
                    background: "linear-gradient(to right, #000000 0%, #330000 25%, #660000 50%, #990000 75%, #FF0000 100%)",
                    color: "white",
                    borderRadius: "8px",
                    padding: "8px",
                  }}
        ...
        {/* ===== Right: Chat Section ===== */}
        <div style={{ flex: "2.5", display: "flex", flexDirection: "column", borderRadius: "10px", padding: "10px" }}>
          <ScrollableDiv>
            {messages.map((msg, index) => (
              <div
                key={index}
              ...
              >
                ...
                />
                <MessageBubble>
                  <p style={{ fontSize: "12px", fontWeight: "bold", margin: 0, color: "#ccc" }}>
                    {msg.username === username ? "You" : msg.username}
                  </p>
                  <p style={{ marginTop: "5px", whiteSpace: "pre-wrap", wordWrap: "break-word" }}>
                    {msg.message}
                  </p>
                  <p style={{ fontSize: "10px", color: "#999", textAlign: "right", marginTop: "5px" }}>
                    {new Date(msg.time).toLocaleTimeString()}
                  </p>
                </MessageBubble>
              </div>
